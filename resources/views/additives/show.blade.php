...
@section('meta')
<!-- Meta OG Tags -->
<meta property="og:title" content="{{ $additive->translation(session('locale'))->additive_name }}" />
<meta property="og:description" content="{{ Str::limit('Discover everything about ' . $additive->translation(session('locale'))->additive_name, 150) }}" />
...
<meta name="twitter:title" content="{{ $additive->translation(session('locale'))->additive_name }}" />
<meta name="twitter:description" content="{{ Str::limit('Discover everything about ' . $additive->translation(session('locale'))->additive_name, 150) }}" />
